...
const polygonMumbaiEndpoint = process.env.POLYGON_MUMBAI_ENDPOINT || DEFAULT_ENDPOINT;
const polygonMumbaiPrivateKey = process.env.POLYGON_MUMBAI_PRIVATE_KEY || DEFAULT_PRIVATE_KEY;
